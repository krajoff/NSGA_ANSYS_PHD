...
DiaYoke = 2443+2*(2*52*11.5/(17.6737-5.1)+6.9+2.95+5.95+(5.5+.5))+2*200 ' Core diameter on yoke side [mm]
Alphas1 = PiConst/3 ' Angle base of wedge  [rad]
AirGap = 13.3752 ' Air gap [mm]
...
RadiusPole = 1003 ' Pole radius [mm]
DiaDamper = 11 ' Pole damper diameter [mm]
LocusDamper = 1003-11/2-8 ' Locus damper radius [mm]
LengthDamper = 962 ' Damper length [mm]
AlphaD = 2*PiConst/108.86 ' Angle between dampers [rad]
ShoeWidthMinor = 488 ' Minor pole shoe width [mm]
ShoeWidthMajor = 488+2 ' Major pole shoe width [mm]
ShoeHeight = 74 ' Pole shoe height [mm]
