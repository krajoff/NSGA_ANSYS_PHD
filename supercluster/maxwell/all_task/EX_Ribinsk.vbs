...
' ---------------------------------------------
'WindingTop =    Array ("a", "a", "z", "z", "b", "b", "b", "x", "x", "c", "c", "y", "y", "a", "a", "a", "z", "z", "b", "b", "x", "x", "c", "c", "c", "y", "y")
'WindingBottom = Array ("y", "a", "a", "z", "z", "b", "b", "x", "x", "x", "c", "c", "y", "y", "a", "a", "z", "z", "z", "b", "b", "x", "x", "c", "c", "y", "y")
WindingTop =    Array ("a", "a", "z", "z", "b", "b", "b", "x", "x", "c")
WindingBottom = Array ("y", "a", "a", "z", "z", "b", "b", "x", "x", "x")
' ---------------------------------------------
' Mesh settings
' ---------------------------------------------
