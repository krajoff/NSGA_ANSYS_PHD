...
' Stator geometry
' ---------------------------------------------
DiaGap = 2402 ' Core diameter on gap side [mm] *
LengthCore = 769 ' Stator core length [mm] *
...
DiaYoke = DiaGap+2*126+2*194 ' Core diameter on yoke side [mm]
...
RadiusPole = 911 ' Pole radius [mm]
DiaDamper = 14 ' Pole damper diameter [mm]
LocusDamper = 911-7-9 ' Locus damper radius [mm]
LengthDamper = 962 ' Damper length [mm]
AlphaD = 2*PiConst/108.86 ' Angle between dampers [rad]
ShoeWidthMinor = 490 ' Minor pole shoe width [mm]
ShoeWidthMajor = 498 ' Major pole shoe width [mm]
ShoeHeight = 73 ' Pole shoe height [mm]
PoleWidth = 350 ' Pole body width [mm]
