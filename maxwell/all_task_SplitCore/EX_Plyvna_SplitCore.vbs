...
CalArea = 17 ' 17 is not needed (used 2). Rotor poles for calculation [-]
...
CurrentRotor = 760 ' Rotor current [A]
' ---------------------------------------------
...
WindingTop = Array("a", "a", "a", "z", "z", "b", "b", "x", "x", "x", "c", "c", "y", "y", "a", "a", "a", "z", "z", "b", "b", "b", "x", "x", "c", "c", "y", "y", "y", "a", "a", "z", "z", "b", "b", "b", "x", "x", "c", "c", "y", "y", "y", "a", "a", "z", "z", "b", "b", "b", "x", "x", "c", "c", "y", "y", "y", "a", "a", "z", "z", "z", "b", "b", "x", "x", "c", "c", "c", "y", "y", "a", "a", "z", "z", "z", "b", "b", "x", "x", "c", "c", "c", "y", "y", "a", "a", "z", "z", "z", "b", "b", "x", "x", "c", "c", "c", "y", "y", "a", "a", "a", "z", "z", "b", "b", "x", "x", "x", "c", "c", "y", "y", "a", "a", "a", "z", "z", "b", "b")
WindingBottom = Array("a", "a", "z", "z", "b", "b", "x", "x", "x", "c", "c", "y", "y", "y", "a", "a", "z", "z", "b", "b", "b", "x", "x", "c", "c", "y", "y", "y", "a", "a", "z", "z", "b", "b", "b", "x", "x", "c", "c", "y", "y", "y", "a", "a", "z", "z", "b", "b", "b", "x", "x", "c", "c", "c", "y", "y", "a", "a", "z", "z", "z", "b", "b", "x", "x", "c", "c", "c", "y", "y", "a", "a", "z", "z", "z", "b", "b", "x", "x", "c", "c", "c", "y", "y", "a", "a", "z", "z", "z", "b", "b", "x", "x", "x", "c", "c", "y", "y", "a", "a", "a", "z", "z", "b", "b", "x", "x", "x", "c", "c", "y", "y", "a", "a", "a", "z", "z", "b", "b", "x")
' ---------------------------------------------
' Mesh settings
' ---------------------------------------------
