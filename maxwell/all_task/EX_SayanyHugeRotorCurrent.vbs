...
DiaYoke = 12550 ' Core diameter on yoke side [mm]
LengthCore = 2700 ' Stator core length [mm]
LenghtTurn = 9290 ' One stator winding turn length [mm]
Z1 = 504 ' Numbers of slots [-]
Bs1 = 40 ' Slot wedge maximum width [mm]
Bs2 = 28.6927 ' Slot body width [mm]
...
RadiusPole = 2052 ' Pole radius [mm]
DiaDamper = 30 ' Pole damper diameter [mm]
LocusDamper = 2030 ' Locus damper radius [mm]
LengthDamper = 2950 ' Damper length [mm]
AlphaD = 2*PiConst/218.97 ' Angle between dampers [rad]
ShoeWidthMinor = 631 ' Minor pole shoe width [mm]
ShoeWidthMajor = 642 ' Major pole shoe width [mm]
ShoeHeight = 62 ' Pole shoe height [mm]
PoleWidth = 504 ' Pole body width [mm]
...
CurrentRotor = 1550*4.6 ' Rotor current [A]
RotLoss = Array(4500, Round(2.99*Tsheet^2, 2), 0)
' ---------------------------------------------
