...
' Stator geometry
' ---------------------------------------------
DiaGap = 10521 ' 1.Core diameter on gap side [mm]
LengthCore = 3042 ' 3.Stator core length [mm]
...
Bs2 = 20.0877 ' 4.Slot body width [mm]
...
DiaYoke = 10521+2*400+2*(2*10.9*72.6/(Bs2-8.1)+12.9+6.45+5.75+(12+1))' 2.Core diameter on yoke side [mm]
Alphas1 = PiConst/3 ' Angle base of wedge  [rad]
AirGap = 22.3743 ' 5.Air gap [mm]
...
RadiusPole = 1798 ' 6.Pole radius [mm]
DiaDamper = 18.2026 ' 7.Pole damper diameter [mm]
LocusDamper = 1798-DiaDamper/2-10' 8.Locus damper radius [mm] 
LengthDamper = 3232 ' Damper length [mm]
AlphaD = 2*PiConst/230.99 ' Angle between dampers [rad]
ShoeWidthMinor = 535 ' 9.Minor pole shoe width [mm]
ShoeWidthMajor = 535+16 ' 10.Major pole shoe width [mm]
ShoeHeight = 56 ' 11.Pole shoe height [mm]
PoleWidth = 405.6 ' 12.Pole body width [mm]
...
Bso = 5 ' 13.Slot opening width [mm]
