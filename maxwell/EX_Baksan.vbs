...
WindingTop =    Array ("a", "a", "a", "a", "a", "z", "z", "z", "z", "z", "b", "b", "b", "b", "b", _
					   "x", "x", "x", "x", "x", "c", "c", "c", "c", "c", "y", "y", "y", "y", "y")
WindingBottom = Array ("a", "a", "a", "z", "z", "z", "z", "z", "b", "b", "b", "b", "b", "x", "x", _
					   "x", "x", "x", "c", "c", "c", "c", "c", "y", "y", "y", "y", "y", "a", "a")
' ---------------------------------------------
' Mesh settings
' ---------------------------------------------
