...
' Stator geometry
' ---------------------------------------------
DiaGap = 10950 ' 1.Core diameter on gap side [mm]
LengthCore = 3000 ' 3.Stator core length [mm]
...
Bs2 = 21.5876 ' 4.Slot body width [mm]
...
DiaYoke = 12030 ' 2.Core diameter on yoke side [mm]
Alphas1 = PiConst/3 ' Angle base of wedge  [rad]
AirGap = 25.4438 ' 5.Air gap [mm]
...
RadiusPole = 1886 ' 6.Pole radius [mm]
DiaDamper = 16.7621 ' 7.Pole damper diameter [mm]
LocusDamper = 1869.619 ' 8.Locus damper radius [mm] 
...
ShoeWidthMajor = 554 ' 10.Major pole shoe width [mm]
ShoeHeight = 57 ' 11.Pole shoe height [mm]
PoleWidth = 450 ' 12.Pole body width [mm]
...
Bso = 3 ' 13.Slot opening width [mm]
