...
' Material stator yoke
  ...
  "ChoiceProperty", "Choice:=", "Hysteresis Model"), "core_loss_kh:=", "0", "core_loss_kc:=", CStr(StTLoss(1)), "core_loss_ke:=", "0", "core_loss_kdc:=", "0", "core_loss_hci:=", "60A_per_meter", "core_loss_br:=", "1tesla", "mass_density:=", "7800")
' Material stator tooth
  ...
  Array("NAME:magnetic_coercivity", "property_type:=", "VectorProperty", "Magnitude:=", _
  "0A_per_meter", "DirComp1:=", "1", "DirComp2:=", "0", "DirComp3:=", "0"),  Array("NAME:core_loss_type", "property_type:=",  _
  "ChoiceProperty", "Choice:=", "Hysteresis Model"), "core_loss_kh:=", "0", "core_loss_kc:=", CStr(StYLoss(1)), "core_loss_ke:=", "0", "core_loss_kdc:=", "0", "core_loss_hci:=", "60A_per_meter", "core_loss_br:=", "1tesla", "mass_density:=", "7800")
' ----------------------------------------------
...
' ----------------------------------------------
  ...
  "0A_per_meter", "DirComp1:=", "1", "DirComp2:=", "0", "DirComp3:=", "0"),  Array("NAME:core_loss_type", "property_type:=",  _
  "ChoiceProperty", "Choice:=", "Hysteresis Model"), "core_loss_kh:=", "0", "core_loss_kc:=", CStr(RotLoss(1)), "core_loss_ke:=", "0", "core_loss_kdc:=", "0", "core_loss_hci:=", "120A_per_meter", "core_loss_br:=", "1tesla", "mass_density:=", "7800")
' ----------------------------------------------
...
oModule.CreateReport "StatorLosses", "Transient", "Rectangular Plot",  _
  "Setup : Transient", Array(), Array("Time:=", Array("All")), _
  Array("X Component:=", "Time", "Y Component:=", Array("CoreLoss(DiaTooth)+CoreLoss(DiaYoke)")), Array()

' Stator rotor  
oModule.CreateReport "RotorLosses", "Transient", "Rectangular Plot",  _
  "Setup : Transient", Array(), Array("Time:=", Array("All")), _
  Array("X Component:=", "Time", "Y Component:=", Array("CoreLoss(PoleShoe)")), Array() 
