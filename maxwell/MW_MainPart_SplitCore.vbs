...
BHStatorYoke = Array("NAME:BHCoordinates", _
  ...
  Array("NAME:Coordinate", "X:=", 68850, "Y:=", 2.15*RatioStator))
BHStatorTooth = Array("NAME:BHCoordinates", _  
  Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), _
  Array("NAME:Coordinate", "X:=", 1.5, "Y:=",  0.01*RatioStator), Array("NAME:Coordinate", "X:=", 3.1, "Y:=",  0.02*RatioStator), _
  Array("NAME:Coordinate", "X:=", 4.6, "Y:=",  0.03*RatioStator), Array("NAME:Coordinate", "X:=", 6.1, "Y:=",  0.04*RatioStator), _
  Array("NAME:Coordinate", "X:=", 7.7, "Y:=",  0.05*RatioStator), Array("NAME:Coordinate", "X:=", 9.2, "Y:=",  0.06*RatioStator), _
  ...
  Array("NAME:Coordinate", "X:=", 68850, "Y:=", 2.15*RatioStator))
For i = 0 to Nsuns
  oDefinitionManager.AddMaterial Array("NAME:" & Material_stator_yoke & "_" & CStr(i), "CoordinateSystemType:=",  _
  "Cartesian", Array("NAME:AttachedData"), Array("NAME:ModifierData"), Array("NAME:permeability", "property_type:=",  _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", BHStatorYoke), "conductivity:=",  "1818100", _
  ...
  CStr(StYLoss(1)), "core_loss_ke:=", CStr(StYLoss(2)), "core_loss_kdc:=", "0", "mass_density:=", "7800")
Next  
' Material stator tooth
  oDefinitionManager.AddMaterial Array("NAME:" & Material_stator_tooth, "CoordinateSystemType:=",  _
  "Cartesian", Array("NAME:AttachedData"), Array("NAME:ModifierData"), Array("NAME:permeability", "property_type:=",  _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", BHStatorTooth), "conductivity:=",  "1818100", _
  Array("NAME:magnetic_coercivity", "property_type:=", "VectorProperty", "Magnitude:=", _
  "0A_per_meter", "DirComp1:=", "1", "DirComp2:=", "0", "DirComp3:=", "0"), Array("NAME:core_loss_type", "property_type:=",  _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", CStr(StTLoss(0)), "core_loss_kc:=",  _
  CStr(StTLoss(1)), "core_loss_ke:=", CStr(StTLoss(2)), "core_loss_kdc:=", "0", "mass_density:=", "7800")
' ----------------------------------------------
...
oEditor.CreateCircle Array("NAME:CircleParameters", "IsCovered:=", true, _
  ...
  "PartCoordinateSystem:=", "Global", "UDMId:=", "", _
  "MaterialValue:=", "" & Chr(34) & Material_stator_yoke & "_0" & Chr(34) & "", _
  "SolveInside:=", true)
oEditor.CreateCircle Array("NAME:CircleParameters", "IsCovered:=", true, _
  "XCenter:=", "0mm", "YCenter:=", "0mm", "ZCenter:=", "0mm", _
  "Radius:=", "$DiaGap/2", "WhichAxis:=",  "Z", "NumSegments:=", "0"), _ 
  Array("NAME:Attributes", "Name:=", "DiaGap", "Flags:=", "", _
  "Color:=", "(192 192 192)", "Transparency:=", 0, _
  "PartCoordinateSystem:=", "Global", "UDMId:=", "", _
  "MaterialValue:=", "" & Chr(34) & Material_stator_yoke & "_0" & Chr(34) & "", _
  "SolveInside:=", true)
oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "DiaYoke", "Tool Parts:=", "DiaGap"), _
...
' ----------------------------------------------  
oEditor.DuplicateAroundAxis Array("NAME:Selections", _
  "Selections:=", "DiaYoke", "NewPartsModelFlag:=", "Model"), _
  Array("NAME:DuplicateAroundAxisParameters", _
  "CreateNewObjects:=", true, "WhichAxis:=", "Z", _
  "AngleStr:=", "0", "NumClones:=", CStr(Nsuns + 1)), _
  Array("NAME:Options", "DuplicateAssignments:=", false), _
  Array("CreateGroupsForNewObjects:=", false)
oEditor.CreateCircle Array("NAME:CircleParameters", "IsCovered:=", true, _
  "XCenter:=", "0mm", "YCenter:=", "0mm", "ZCenter:=", "0mm", _ 
  "Radius:=", "$DiaGap/2+$Hs0*0.95", "WhichAxis:=", "Z", "NumSegments:=", "0"), _
  Array("NAME:Attributes", "Name:=", "DiaYoke_0", "Flags:=", "", _
  "Color:=", "(192 192 192)", "Transparency:=", 0, "PartCoordinateSystem:=",  _
  "Global", "UDMId:=", "", "MaterialValue:=", "" & Chr(34) & Material_stator_yoke & "_0" & Chr(34) & "", _
  "SolveInside:=", true)
' Create cutters
For i = 1 to Nsuns
  oEditor.CreateCircle Array("NAME:CircleParameters", "IsCovered:=", true, _
  "XCenter:=", "0mm", "YCenter:=", "0mm", "ZCenter:=", "0mm", _ 
  "Radius:=", "$DiaGap/2+$Hs0+($DiaYoke-$DiaGap-2*$Hs0)*" & CStr(i/(2*Nsuns)), _
  "WhichAxis:=", "Z", "NumSegments:=", "0"), _
  Array("NAME:Attributes", "Name:=", "DiaCutter_" & CStr(i), "Flags:=", "", _
  "Color:=", "(192 192 192)", "Transparency:=", 0, "PartCoordinateSystem:=",  _
  "Global", "UDMId:=", "", "MaterialValue:=", "" & Chr(34) & Material_stator_yoke & "_0" & Chr(34) & "", _
  "SolveInside:=", true)
Next
oEditor.Intersect Array("NAME:Selections", "Selections:=", "DiaYoke_0,DiaYoke"), _
  Array("NAME:IntersectParameters", "KeepOriginals:=", false)
For i = 1 to Nsuns
  For j = 0 to i-1
    oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "DiaYoke_" & CStr(i), "Tool Parts:=", "DiaYoke_" & CStr(j)), _
    Array("NAME:SubtractParameters", "KeepOriginals:=", true)
  Next
  oEditor.Intersect Array("NAME:Selections", "Selections:=", "DiaYoke_" & CStr(i) & ",DiaCutter_" & CStr(i)), _
  Array("NAME:IntersectParameters", "KeepOriginals:=", false)
Next
'For i = 0 to Nsuns-2
'  oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "DiaYoke_" & CStr(Nsuns-1), "Tool Parts:=", "DiaYoke_" & CStr(i)), _
'  Array("NAME:SubtractParameters", "KeepOriginals:=", true)
'Next
For i = 0 to Nsuns
  oEditor.SetWCS Array("NAME:SetWCS Parameter", "Working Coordinate System:=", "SplitPoleLeft", "RegionDepCSOk:=", false)
  oEditor.Split Array("NAME:Selections", "Selections:=", "DiaYoke_" & CStr(i), "NewPartsModelFlag:=", "Model"), _
	Array("NAME:SplitToParameters", "SplitPlane:=", "YZ", "WhichSide:=", "PositiveOnly", _
	"ToolType:=", "PlaneTool", "ToolEntityID:=", -1, "SplitCrossingObjectsOnly:=", false, "DeleteInvalidObjects:=", true)
  oEditor.SetWCS Array("NAME:SetWCS Parameter", "Working Coordinate System:=", "SplitPoleRight", "RegionDepCSOk:=", false)
  oEditor.Split Array("NAME:Selections", "Selections:=", "DiaYoke_" & CStr(i), "NewPartsModelFlag:=", "Model"), _
	Array("NAME:SplitToParameters", "SplitPlane:=", "YZ", "WhichSide:=", "PositiveOnly", _
	"ToolType:=", "PlaneTool", "ToolEntityID:=", -1, "SplitCrossingObjectsOnly:=", false, "DeleteInvalidObjects:=", true)
Next
' ----------------------------------------------
' Create Yoke Spliters
' ----------------------------------------------  
oEditor.SetWCS Array("NAME:SetWCS Parameter", "Working Coordinate System:=", "AngleD", "RegionDepCSOk:=", false)
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", "Mode:=", "Axis/Position", _
  "OriginX:=", "0mm", "OriginY:=", "0mm", "OriginZ:=", "0mm", _
  "XAxisXvec:=", "1mm*($DiaGap/2+1.1*$Hs0)/($Bs2/2)", "XAxisYvec:=", "1mm", "XAxisZvec:=", "0mm", _
  "YAxisXvec:=", "0mm", "YAxisYvec:=",  "1mm", "YAxisZvec:=", "0mm"), Array("NAME:Attributes", "Name:=", "YokeR1")
oEditor.Split Array("NAME:Selections", "Selections:=", "DiaYoke_1", "NewPartsModelFlag:=", "Model"), _
  Array("NAME:SplitToParameters", "SplitPlane:=", "YZ", "WhichSide:=", "Both", "ToolType:=", "PlaneTool", _
  "ToolEntityID:=", -1, "SplitCrossingObjectsOnly:=", false, "DeleteInvalidObjects:=", false)
oEditor.SetWCS Array("NAME:SetWCS Parameter", "Working Coordinate System:=", "AngleD", "RegionDepCSOk:=", false)
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", "Mode:=", "Axis/Position", "OriginX:=",  _
  "0mm", "OriginY:=", "0mm", "OriginZ:=", "0mm", _
  "XAxisXvec:=", "-1mm*($DiaGap/2+1.1*$Hs0)/($Bs2/2)", "XAxisYvec:=", "1mm", "XAxisZvec:=", "0mm", _
  "YAxisXvec:=", "0mm", "YAxisYvec:=", "1mm", "YAxisZvec:=", "0mm"), Array("NAME:Attributes", "Name:=", "YokeR2")
oEditor.Split Array("NAME:Selections", "Selections:=", "DiaYoke_1_Split1", "NewPartsModelFlag:=",  _
  "Model"), Array("NAME:SplitToParameters", "SplitPlane:=", "YZ", "WhichSide:=", "Both", "ToolType:=",  _
  "PlaneTool", "ToolEntityID:=", -1, "SplitCrossingObjectsOnly:=", false, "DeleteInvalidObjects:=", false)
oEditor.SetWCS Array("NAME:SetWCS Parameter", "Working Coordinate System:=", "YokeR1", "RegionDepCSOk:=", false)
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", "Mode:=", "Axis/Position", _
  "OriginX:=", "0mm", "OriginY:=", "0mm", "OriginZ:=", "0mm", _
  "XAxisXvec:=", "-1/tan(2*" & CStr(PiConst) & "/$Z1)*1mm", "XAxisYvec:=", "1mm", "XAxisZvec:=", "0mm", _ 
  "YAxisXvec:=", "0mm", "YAxisYvec:=", "1mm", "YAxisZvec:=", "0mm"), Array("NAME:Attributes", "Name:=", "YokeR3")
oEditor.Split Array("NAME:Selections", "Selections:=", "DiaYoke_1_Split1", "NewPartsModelFlag:=",  _
  "Model"), Array("NAME:SplitToParameters", "SplitPlane:=", "YZ", "WhichSide:=",  _
  "PositiveOnly", "ToolType:=", "PlaneTool", "ToolEntityID:=", -1, "SplitCrossingObjectsOnly:=",  _
  false, "DeleteInvalidObjects:=", false)
oEditor.DuplicateAroundAxis Array("NAME:Selections", "Selections:=", "DiaYoke_1_Split1", "NewPartsModelFlag:=", "Model"), _
  Array("NAME:DuplicateAroundAxisParameters", "CreateNewObjects:=", false, "WhichAxis:=", "Z", _
  "AngleStr:=", "2*"& CStr(PiConst) &"/$Z1", "NumClones:=", CStr(Round(Z1/Poles*CalArea))), _
  Array("NAME:Options", "DuplicateAssignments:=", false), Array("CreateGroupsForNewObjects:=", false)
oEditor.DuplicateAroundAxis Array("NAME:Selections", "Selections:=", "DiaYoke_1_Split1_Split1", "NewPartsModelFlag:=", "Model"), _
  Array("NAME:DuplicateAroundAxisParameters", "CreateNewObjects:=", false, "WhichAxis:=", "Z", _
  "AngleStr:=", "2*"& CStr(PiConst) &"/$Z1", "NumClones:=", CStr(Round(Z1/Poles*CalArea))), _
  Array("NAME:Options", "DuplicateAssignments:=", false), Array("CreateGroupsForNewObjects:=", false)  
oEditor.SetWCS Array("NAME:SetWCS Parameter", "Working Coordinate System:=", "SplitPoleRight", "RegionDepCSOk:=", false)
oEditor.Unite Array("NAME:Selections", "Selections:=", "DiaYoke_1,DiaYoke_1_Split1"), _
...
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Geometry3DAttributeTab", Array("NAME:PropServers",  _
  "DiaYoke_1_Split1_Split1"), Array("NAME:ChangedProps", Array("NAME:Name", "Value:=", "DiaYoke_1_Slot"))))
oEditor.Split Array("NAME:Selections", "Selections:=", "DiaYoke_1", "NewPartsModelFlag:=",  "Model"), _
   Array("NAME:SplitToParameters", "SplitPlane:=", "YZ", "WhichSide:=", "PositiveOnly", "ToolType:=", _ 
   "PlaneTool", "ToolEntityID:=", -1, "SplitCrossingObjectsOnly:=", false, "DeleteInvalidObjects:=", false)
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Geometry3DAttributeTab", Array("NAME:PropServers",  _
  "DiaYoke_0"), Array("NAME:ChangedProps", Array("NAME:Material", "Value:=",  _
  "" & Chr(34) & Material_stator_tooth & Chr(34) & ""))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Geometry3DAttributeTab", Array("NAME:PropServers",  _
  "DiaYoke_1_Slot"), Array("NAME:ChangedProps", Array("NAME:Material", "Value:=",  _
  "" & Chr(34) & Material_stator_yoke & "_0" & Chr(34) & ""))))  
For i = 1 to Nsuns    
   oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Geometry3DAttributeTab", Array("NAME:PropServers",  _
  "DiaYoke_" & CStr(i)), Array("NAME:ChangedProps", Array("NAME:Material", "Value:=",  _
  "" & Chr(34) & Material_stator_yoke & "_" & CStr(i) & Chr(34) & ""))))
Next
...
' Return new WindingTop and WindingBottom throught SwArrayM array 
' to elucidate NNull-position: 1. multiplied by two; 2. return new variant 
' SwArrayM, WindingTop and WindingBottom	
' ----------------------------------------------
Dim SwArrayM()
...
oEditor.Split Array("NAME:Selections", _
  "Selections:=", "RimRotorOut,RimRotorIn,SmallAirSector,Mover", _
  "NewPartsModelFlag:=", "Model"), _
  Array("NAME:SplitToParameters", _
  "SplitPlane:=", "YZ", _
  "WhichSide:=", "PositiveOnly", _
...
' Set core losses
' ----------------------------------------------  
ReDim pShoeLosses(CalArea+Nsuns+1)
k = 0
...
End If  
For i = 0 to Nsuns
  pShoeLosses(k) = "DiaYoke_" & CStr(i)
  k = k + 1
Next
  pShoeLosses(k) = "DiaYoke_1_Slot"
oModule.SetCoreLoss pShoeLosses, false  
' ----------------------------------------------
' Polyline CenterAirGap and PolyYokes
' ----------------------------------------------
oEditor.SetWCS Array("NAME:SetWCS Parameter", "Working Coordinate System:=", "SplitPoleLeft")
If CalArea > 1 Then
  PolyCalArea = 2
...
For i = 1 to Nsuns-1  
  oEditor.CreatePolyline Array("NAME:PolylineParameters", "IsPolylineCovered:=", true, "IsPolylineClosed:=", false, _
  Array("NAME:PolylinePoints", Array("NAME:PLPoint", "X:=", "0mm", "Y:=", "$DiaGap/2+$Hs0+($DiaYoke-$DiaGap-2*$Hs0)*" & CStr((1.5+(i-1))/(2*Nsuns)), "Z:=", "0mm")), _
  Array("NAME:PolylineSegments", Array("NAME:PLSegment", "SegmentType:=", "AngularArc", "StartIndex:=", 0, "NoOfPoints:=", 3, _
  "NoOfSegments:=", "0", "ArcAngle:=", "-2*" & CStr(PiConst*PolyCalArea) & "/$Poles", _
  "ArcCenterX:=", "0mm", "ArcCenterY:=", "0mm", "ArcCenterZ:=", "0mm", "ArcPlane:=", "XY")), _
  Array("NAME:PolylineXSection", "XSectionType:=", "None", "XSectionOrient:=", "Auto", _
  "XSectionWidth:=", "0mm", "XSectionTopWidth:=", "0mm", "XSectionHeight:=", "0mm", "XSectionNumSegments:=", "0", "XSectionBendType:=", "Corner")), _
  Array("NAME:Attributes", "Name:=", "PolyYokes_" & CStr(i), "Flags:=", "NonModel#", "Color:=", "(132 132 193)", "Transparency:=", 0, _
  "PartCoordinateSystem:=", "Global", "UDMId:=", "", "MaterialValue:=", "" & Chr(34) & "vacuum" & Chr(34) & "", "SolveInside:=", true)
Next   
oEditor.SetWCS Array("NAME:SetWCS Parameter", "Working Coordinate System:=", "Global")
' ----------------------------------------------
...
If Multiplier <> undefined then
	If Multiplier <> 1 then
		Symmetry = "1"
	Else
		Symmetry = "$Poles/$CalArea"
	End If
Else
	Symmetry = "$Poles/$CalArea"
	Multiplier = 1
...
oDesign.SetDesignSettings Array("NAME:Design Settings Data", "PreserveTranSolnAfterDatasetEdit:=",  _
  ...
  false, "BackgroundMaterialName:=", "vacuum-air", "Multiplier:=", Symmetry)
' ----------------------------------------------
...
End If
ReDim MeshWSt(2*NumberWSE-1+SlotPole*CalArea+2*CoilRotor*CalArea+6+(CalArea-1))
k = 0
' Stator windings
...
' DiaYoke_0 and DiaYoke_1, Pole shoes, band and mover
MeshWSt(k) = "DiaYoke_0" 
k = k + 1
MeshWSt(k) = "DiaYoke_1" 
k = k + 1
MeshWSt(k) = "DiaYoke_1_Slot" 
k = k + 1
MeshWSt(k) = "PoleShoe"
k = k + 1
MeshWSt(k) = "Band"
...
End If
' DiaYoke_>1 
ReDim MeshDiaYoke(Nsuns-2)
For i = 0 to Nsuns-2
  MeshDiaYoke(i) = "DiaYoke_" & CStr(i+2)
Next
' ----------------------------------------------
...
' ----------------------------------------------
' Create setup. Apply mesh operations. "StopTime:=", CStr(1.0/Frequency/RtFrq) & "s", _     "TimeStep:=", CStr(Frequency^(-1)/NumberSteps) & "s", _
' ----------------------------------------------
...
oModule.InsertSetup "Transient", Array("NAME:Setup", "Enabled:=", true, _
  ...
  "StopTime:=", CStr(Frequency^(-1)/NumberSteps) & "s", _
...
oModule.CreateReport "StatorCurrent", "Transient", "Rectangular Plot",  _
  ...
  Array("X Component:=", "Time", "Y Component:=", Array("$Poles/$CalArea*Current(WindingStatorAX)")), Array()
oModule.AddTraces "StatorCurrent", "Setup : Transient", Array(), _
  Array("Time:=", Array("All")), Array("X Component:=", "Time", _
  "Y Component:=", Array("$Poles/$CalArea*Current(WindingStatorBY)")), Array()
oModule.AddTraces "StatorCurrent", "Setup : Transient", Array(), _
  Array("Time:=", Array("All")), Array("X Component:=", "Time", _
  "Y Component:=", Array("$Poles/$CalArea*Current(WindingStatorCZ)")), Array()
  
' Stator voltage
oModule.CreateReport "StatorVoltage", "Transient", "Rectangular Plot",  _
  "Setup : Transient", Array(), Array("Time:=", Array("All")), _
  Array("X Component:=", "Time", "Y Component:=", Array("$Poles/$CalArea*(InducedVoltage(WindingStatorAX)-InducedVoltage(WindingStatorBY))")), Array()
oModule.AddTraces "StatorVoltage", "Setup : Transient", Array(), _
  Array("Time:=", Array("All")), Array("X Component:=", "Time", _
  "Y Component:=", Array("$Poles/$CalArea*(InducedVoltage(WindingStatorBY)-InducedVoltage(WindingStatorCZ))")), Array()
oModule.AddTraces "StatorVoltage", "Setup : Transient", Array(), _
  Array("Time:=", Array("All")), Array("X Component:=", "Time", _
  "Y Component:=", Array("$Poles/$CalArea*(InducedVoltage(WindingStatorCZ)-InducedVoltage(WindingStatorAX))")), Array()
...
oModule.CreateReport "FFTStatorVoltage", "Transient", "Data Table",  _
  ...
  Array("X Component:=", "Freq", "Y Component:=", Array("$Poles/$CalArea*mag(InducedVoltage(WindingStatorAX)-InducedVoltage(WindingStatorBY))")), Array()
oModule.AddTraces "FFTStatorVoltage", "Setup : Transient", Array("Domain:=", "Spectral", _
  "StartTime:=", 0, "EndTime:=", 1.0*Frequency^(-1)/RtFrq, _
  "MaxHarmonic:=", 101, "NumSamples:=", NumberSteps+1, "WindowType:=", 0, "Normalize:=", 0, "Periodic:=", 0, "FundementalFreq:=", Frequency, _
  "CutoffFreq:=", 0), Array("Freq:=", Array("All")), _
  Array("X Component:=", "Freq", "Y Component:=", Array("$Poles/$CalArea*mag(InducedVoltage(WindingStatorBY)-InducedVoltage(WindingStatorCZ))")), Array()
oModule.AddTraces "FFTStatorVoltage", "Setup : Transient", Array("Domain:=",  _
  "Spectral", "StartTime:=", 0, "EndTime:=", 1.0*Frequency^(-1)/RtFrq, _
  "MaxHarmonic:=", 101, "NumSamples:=", NumberSteps+1, "WindowType:=", 0, "Normalize:=", 0, "Periodic:=", 0, "FundementalFreq:=", Frequency, _
  "CutoffFreq:=", 0), Array("Freq:=", Array("All")), _
  Array("X Component:=", "Freq", "Y Component:=", Array("$Poles/$CalArea*mag(InducedVoltage(WindingStatorCZ)-InducedVoltage(WindingStatorAX))")), Array()
oModule.ChangeProperty Array("NAME:AllTabs", Array("NAME:Data Filter", Array("NAME:PropServers",  _
  "FFTStatorVoltage:$Poles/$CalArea*mag(InducedVoltage(WindingStatorAX)-InducedVoltage(WindingStatorBY)):Curve1"), _ 
  Array("NAME:ChangedProps", Array("NAME:Units", "Value:=", "megV"))))
oModule.ChangeProperty Array("NAME:AllTabs", Array("NAME:Data Filter", Array("NAME:PropServers",  _
  "FFTStatorVoltage:$Poles/$CalArea*mag(InducedVoltage(WindingStatorAX)-InducedVoltage(WindingStatorBY)):Curve1"), _
  Array("NAME:ChangedProps", Array("NAME:Units", "Value:=", "V")))) 
oModule.ChangeProperty Array("NAME:AllTabs", Array("NAME:Data Filter", Array("NAME:PropServers",  _
  "FFTStatorVoltage:$Poles/$CalArea*mag(InducedVoltage(WindingStatorBY)-InducedVoltage(WindingStatorCZ)):Curve1"), _ 
  Array("NAME:ChangedProps", Array("NAME:Units", "Value:=", "megV"))))
oModule.ChangeProperty Array("NAME:AllTabs", Array("NAME:Data Filter", Array("NAME:PropServers",  _
  "FFTStatorVoltage:$Poles/$CalArea*mag(InducedVoltage(WindingStatorBY)-InducedVoltage(WindingStatorCZ)):Curve1"), _ 
  Array("NAME:ChangedProps", Array("NAME:Units", "Value:=", "V"))))    
oModule.ChangeProperty Array("NAME:AllTabs", Array("NAME:Data Filter", Array("NAME:PropServers",  _
  "FFTStatorVoltage:$Poles/$CalArea*mag(InducedVoltage(WindingStatorCZ)-InducedVoltage(WindingStatorAX)):Curve1"), _ 
  Array("NAME:ChangedProps", Array("NAME:Units", "Value:=", "megV"))))
oModule.ChangeProperty Array("NAME:AllTabs", Array("NAME:Data Filter", Array("NAME:PropServers",  _
  "FFTStatorVoltage:$Poles/$CalArea*mag(InducedVoltage(WindingStatorCZ)-InducedVoltage(WindingStatorAX)):Curve1"), _ 
  Array("NAME:ChangedProps", Array("NAME:Units", "Value:=", "V"))))   
...
' ----------------------------------------------
' Stator losses  
StrLossesStator = "CoreLoss(DiaYoke_0)+CoreLoss(DiaYoke_1)+CoreLoss(DiaYoke_1_Slot)"
For i = 1 to Nsuns-2
  StrLossesStator = StrLossesStator & "+CoreLoss(DiaYoke_" & CStr(i+1) & ")" 
Next
oModule.CreateReport "StatorLosses", "Transient", "Rectangular Plot",  _
  "Setup : Transient", Array(), Array("Time:=", Array("All")), _
  Array("X Component:=", "Time", "Y Component:=", Array("$Poles/$CalArea*(" & StrLossesStator & ")")), Array()
' Rotor losses  
oModule.CreateReport "RotorLosses", "Transient", "Rectangular Plot",  _
  "Setup : Transient", Array(), Array("Time:=", Array("All")), _
  Array("X Component:=", "Time", "Y Component:=", Array("$Poles/$CalArea*CoreLoss(PoleShoe)")), Array() 
' Solid damper losses 
oModule.CreateReport "DamperLosses", "Transient", "Rectangular Plot",  _
  "Setup : Transient", Array(), Array("Time:=", Array("All")), _
  Array("X Component:=", "Time", "Y Component:=", Array("$Poles/$CalArea*SolidLoss")), Array()
' Rotor current  
