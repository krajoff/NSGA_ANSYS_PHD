...
oModule.CreateReport "StatorVoltage", "Transient", "Rectangular Plot",  _
  "Setup : Transient", Array(), Array("Time:=", Array("All")), _
  Array("X Component:=", "Time", "Y Component:=", Array(CStr(Multiplier) & "*(InducedVoltage(WindingStatorAX)-InducedVoltage(WindingStatorBY))")), Array()
oModule.AddTraces "StatorVoltage", "Setup : Transient", Array(), _
  Array("Time:=", Array("All")), Array("X Component:=", "Time", _
  "Y Component:=", Array(CStr(Multiplier) & "*(InducedVoltage(WindingStatorBY)-InducedVoltage(WindingStatorCZ))")), Array()
oModule.AddTraces "StatorVoltage", "Setup : Transient", Array(), _
  Array("Time:=", Array("All")), Array("X Component:=", "Time", _
  "Y Component:=", Array(CStr(Multiplier) & "*(InducedVoltage(WindingStatorCZ)-InducedVoltage(WindingStatorAX))")), Array()
...
oModule.CreateReport "StatorLosses", "Transient", "Rectangular Plot",  _
  "Setup : Transient", Array(), Array("Time:=", Array("All")), _
  Array("X Component:=", "Time", "Y Component:=", Array(CStr(Multiplier) & "*(CoreLoss(DiaTooth)+CoreLoss(DiaYoke))")), Array()

' Stator rotor  
oModule.CreateReport "RotorLosses", "Transient", "Rectangular Plot",  _
  "Setup : Transient", Array(), Array("Time:=", Array("All")), _
  Array("X Component:=", "Time", "Y Component:=", Array(CStr(Multiplier) & "*CoreLoss(PoleShoe)")), Array() 
 
' Solid damper losses 
oModule.CreateReport "DamperLosses", "Transient", "Rectangular Plot",  _
  "Setup : Transient", Array(), Array("Time:=", Array("All")), _
  Array("X Component:=", "Time", "Y Component:=", Array(CStr(Multiplier) & "*SolidLoss")), Array()
