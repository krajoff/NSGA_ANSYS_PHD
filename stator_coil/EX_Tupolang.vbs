...
' Initial parameters in mm, rad, T, A/m, A
  Station = "HHP Tupolang"
' ---------------------------------------------
PiConst = 4*atn(1)
MainFolder = "D:\NSGA_ANSYS_PHD\stator_coil\"
ExternalCircuit = "CC_NoLoadTupolang.sph"
IncTitle = "" ' "example" & IncTitle & ".csv"
Solver = 1 ' If 0 then Maxwell else ANSYS R19.1
' ---------------------------------------------
' Stator geometry:
' ---------------------------------------------
DiaGap = 3900 ' Core diameter on gap side [mm]
LengthCore = 1800 ' Stator core length [mm]
LenghtTurn = 6420 ' One stator winding turn length [mm]
Z1 = 192 ' Numbers of slots [-]
Bs1 = 30.7 ' Slot wedge maximum width [mm]
Bs2 = 24.0 ' Slot body width [mm]
Hs1 = 8.0 ' Slot wedge height [mm]
Hs2 = .8 ' Slot closed bridge height [mm]
Bsw = Bs2-6.1 ' Stator winding width [mm]
Hsw = 17.9*67.5/Bsw' Stator winding height [mm]
Hsw_gap = 2.3 ' Distance between stator winding and slot bottom [mm]
Hsw_between = 6.0 ' Distance between stator windings [mm]
Hs0 = 72.4*2+3.6+6+Hsw_gap ' Slot opening height [mm]
DiaYoke = 4770 ' Core diameter on yoke side [mm]
Alphas1 = PiConst/3 ' Angle base of wedge  [rad]
AirGap = 16 ' Air gap [mm]
...
CoilPitch = 10 ' Stator coil pitch [-] (1-11)
SVolt = 10500 ' Stator winding voltage [V]
SCurrent = 5077 ' Stator winding current [A]
...
RadiusPole = 1365.6 ' Pole radius [mm]
DiaDamper = 20.0 ' Pole damper diameter [mm]
LocusDamper = 1347.6 ' Locus damper radius [mm]
LengthDamper = 2020 ' Damper length [mm]
AlphaD = 2*PiConst/166.014 ' Angle between dampers [rad]
ShoeWidthMinor = 270*2 ' Minor pole shoe width [mm]
ShoeWidthMajor = 270*2 ' Major pole shoe width [mm]
ShoeHeight = 80 ' Pole shoe height [mm]
PoleWidth = 400 ' Pole body width [mm]
PoleHeight = 340 ' Pole body height [mm]
PoleLength = 1880 ' Pole body length [mm]
...
CoilRotorPr = 41 ' Rotor winding for winding parameters[-]
CalArea = 16 ' Rotor poles for calculation [-]
...
ResistanceRotor_15C = .1199 ' Calculated rotor active resistance 15 C [ohm]
ResistanceStator_15C = .00193 ' Calculated phase stator active resistance 15 C [ohm]
TestTime = 10 ' Test time [s]
NoLoadTime = 1 ' Initial time of no-load running [s] 
VoltageRotor = 10 ' Rotor voltage [V]
CurrentRotor = 435 ' Rotor current [A]
' ---------------------------------------------
WindingTop = Array ("a", "a", "a", "a", "z", "z", "z", "z", "b", "b", "b", "b", "x", "x", "x", "x", "c", "c", "c", "c", "y", "y", "y", "y", "a", "a", "a", "a", "z", "z", "z", "z", "b", "b", "b", "b", "x", "x", "x", "x", "c", "c", "c", "c", "y", "y", "y", "y")
WindingBottom = Array ("y", "y", "a", "a", "a", "a", "z", "z", "z", "z", "b", "b", "b", "b", "x", "x", "x", "x", "c", "c", "c", "c", "y", "y", "y", "y", "a", "a", "a", "a", "z", "z", "z", "z", "b", "b", "b", "b", "x", "x", "x", "x", "c", "c", "c", "c", "y", "y")
' ---------------------------------------------
' Mesh settings
' ---------------------------------------------
MSizeWSt = 2 ' Mesh size of stator windings, dampers, diaTooth, poleShoe, band, rotor windings [mm]
...
MSizeAirIn = 50 ' Mesh size of inside air [mm]
' ---------------------------------------------
