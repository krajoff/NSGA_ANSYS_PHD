...
%
fid =  fopen([pwd '\populations1with6functions.txt'],'r');    
datacell = textscan(fid, '%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'Delimiter', '\t');
degMLoss = 1;
degMega = 10^6;
% The rated values
xnom = 0.153324;
...
xst = datacell{18}./xsubtrnom; % xd''
xsi = datacell{19}./xsinom; % xd
...
%% Plot settings
line(x, y, xsi, 'marker', '.', 'markersize', 5, 'linestyle', 'none', 'Color','w');
...
%axis([0.5, 2.0, 0.85, 1.15, (0.0)^degMLoss, (1.5)^degMLoss]);
