function Results=normalitytest(x, cluster, point)
...
disp(' ') 
disp(['Test Name (Cluster=' int2str(cluster) ', Point=' int2str(point) ') Test Statistic   p-value   Normality (1:Normal,0:Not Normal)'])
disp('-----------------------    --------------  ---------  --------------------------------')
